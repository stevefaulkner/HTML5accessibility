...
var globalStates = ["aria-current", "aria-controls","aria-details", "aria-disabled", "aria-haspopup", "aria-hidden", "aria-labelledby", "aria-label", "aria-describedby", "aria-owns", "aria-flowto","aria-keyshortcuts", "aria-errormessage", "aria-live","aria-atomic", "aria-busy", "aria-relevant", "aria-roledescription"];
